...
def parse_args():
    ...
    parser.add_argument("--decreasing_lr", default="90,120", help="decreasing strategy")
    parser.add_argument(
        "--no-aug",
        action="store_true",
        default=False,
    ...
    parser.add_argument("--sample_forget_type",default="random",type=str,choices=["random","1_2LT","1_3LT","LT","LT1.5","LT2","uniform","softLT"],help="the distributions of samples to be forgotten")
    parser.add_argument("--imbalance_factor",default=0.25,type=float,help="when sample_forget_type is LT, the imbalance ratio")
    parser.add_argument("--alpha", default=0.2, type=float, help="unlearn noise")
    parser.add_argument("--beta",default=0.75,type=float,help="reweighing param")
